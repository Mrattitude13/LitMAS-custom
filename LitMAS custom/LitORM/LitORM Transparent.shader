...
// Force reimport: 2
Shader "LitMAS custom/LitORM/LitORM Transparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float MyCustomExpression217_g329( float detailSmooth, float smoothness )
			{
				...
				) : SV_Target
			{
				...
				float4 tex2DNode42 = tex2D( _BaseMap, uv_BaseMap );
				float4 temp_output_49_0 = ( tex2DNode42 * _BaseColor );
				float4 temp_output_21_0_g329 = temp_output_49_0;
				float4 temp_output_109_0_g330 = round( temp_output_21_0_g329 );
				float2 temp_output_218_0_g329 = uv_BaseMap;
				float4 tex2DNode1_g329 = tex2D( _DetailMap, ( ( temp_output_218_0_g329 * _DetailMap_ST.xy ) + _DetailMap_ST.zw ) );
				#ifdef _DETAILS_ON
				float4 staticSwitch16_g329 = ( ( temp_output_109_0_g330 * ( 1.0 - ( ( 1.0 - temp_output_21_0_g329 ) * ( 1.0 - (tex2DNode1_g329.r).xxxx ) * 2.0 ) ) ) + ( ( 1.0 - temp_output_109_0_g330 ) * ( temp_output_21_0_g329 * (tex2DNode1_g329.r).xxxx * 2.0 ) ) );
				#else
				float4 staticSwitch16_g329 = temp_output_21_0_g329;
				#endif
				
				float2 uv_BumpMap43 = i.uv0XY_bitZ_fog.xy;
				float4 In02_g328 = tex2D( _BumpMap, uv_BumpMap43 );
				float3 localMyCustomExpression2_g328 = MyCustomExpression( In02_g328 );
				float3 temp_output_48_0 = localMyCustomExpression2_g328;
				float4 temp_output_22_0_g329 = float4( temp_output_48_0 , 0.0 );
				float2 temp_output_57_0_g329 = (tex2DNode1_g329).ga;
				float2 break79_g329 = temp_output_57_0_g329;
				float3 appendResult56_g329 = (float3(break79_g329.y , break79_g329.x , 1.0));
				float3 temp_cast_6 = (1.0).xxx;
				#ifdef _DETAILS_ON
				float4 staticSwitch26_g329 = float4( BlendNormal( temp_output_22_0_g329.rgb , ( ( appendResult56_g329 * 2.0 ) - temp_cast_6 ) ) , 0.0 );
				#else
				float4 staticSwitch26_g329 = temp_output_22_0_g329;
				#endif
				
				float4 color44 = IsGammaSpace() ? float4( 0, 0, 0, 0 ) : float4( 0, 0, 0, 0 );
				float2 uv_EmissionMap40 = i.uv0XY_bitZ_fog.xy;
				#ifdef _EMISSION_ON
				float4 staticSwitch50 = ( tex2D( _EmissionMap, uv_EmissionMap40 ) * _EmissionColor );
				#else
				float4 staticSwitch50 = color44;
				#endif
				float3 temp_output_13_0_g333 = staticSwitch50.rgb;
				float2 uv_ORM = i.uv0XY_bitZ_fog.xy * _ORM_ST.xy + _ORM_ST.zw;
				float4 tex2DNode46 = tex2D( _ORM, uv_ORM );
				float localBakerySpecMonoSHFull4_g334 = ( 0.0 );
				float3 ase_tangentWS = i.ase_texcoord7.xyz;
				float3 mapNormal16_g336 = temp_output_48_0;
				float3 ase_bitangentWS = i.ase_texcoord8.xyz;
				float3 ase_normalWS = i.ase_texcoord9.xyz;
				float3 normalizeResult18_g336 = normalize( ( ( ase_tangentWS * mapNormal16_g336.x ) + ( ase_bitangentWS * mapNormal16_g336.y ) + ( ase_normalWS * mapNormal16_g336.z ) ) );
				float3 normalWorld4_g334 = normalizeResult18_g336;
				float2 lightmapUV4_g334 = (i.ase_texcoord10.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - i.wPos.xyz );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float3 normalizeResult2_g334 = normalize( ase_viewDirWS );
				float3 viewDir4_g334 = normalizeResult2_g334;
				float temp_output_52_0 = ( 1.0 - tex2DNode46.g );
				float smoothness4_g334 = temp_output_52_0;
				float3 temp_output_9_0_g333 = temp_output_49_0.rgb;
				float3 albedo4_g334 = temp_output_9_0_g333;
				float metalness4_g334 = tex2DNode46.b;
				float3 diffuseSH4_g334 = float3( 0,0,0 );
				float3 specularSH4_g334 = float3( 0,0,0 );
				BakerySpecMonoSHFull_float( normalWorld4_g334 , lightmapUV4_g334 , viewDir4_g334 , smoothness4_g334 , albedo4_g334 , metalness4_g334 , diffuseSH4_g334 , specularSH4_g334 );
				#ifdef _MONOSHENABLED_ON
				float3 staticSwitch30_g333 = ( ( temp_output_13_0_g333 + ( tex2DNode46.r * ( diffuseSH4_g334 * temp_output_9_0_g333 ) ) ) + ( specularSH4_g334 * _MonoSHAdjustment ) );
				#else
				float3 staticSwitch30_g333 = temp_output_13_0_g333;
				#endif
				
				float3 temp_cast_11 = (_Cull).xxx;
				
				float temp_output_23_0_g329 = temp_output_52_0;
				float detailSmooth217_g329 = tex2DNode1_g329.b;
				float smoothness217_g329 = temp_output_23_0_g329;
				float localMyCustomExpression217_g329 = MyCustomExpression217_g329( detailSmooth217_g329 , smoothness217_g329 );
				#ifdef _DETAILS_ON
				float staticSwitch17_g329 = localMyCustomExpression217_g329;
				#else
				float staticSwitch17_g329 = temp_output_23_0_g329;
				#endif
				
				float4 temp_cast_12 = (tex2DNode42.a).xxxx;
				float2 uv_Alphamap = i.uv0XY_bitZ_fog.xy * _Alphamap_ST.xy + _Alphamap_ST.zw;
				#ifdef _USEALPHAMAP_ON
				float4 staticSwitch55 = tex2D( _Alphamap, uv_Alphamap );
				#else
				float4 staticSwitch55 = temp_cast_12;
				#endif
			...
			//---------------------------------------------------------------------------------------------------------------------------
				...
				half3 albedo3 = staticSwitch16_g329.rgb;
				half3 normalTS = staticSwitch26_g329.rgb;
				half3 emission = staticSwitch30_g333;
			...
			// End Injection NORMAL_MAP from Injection_NormalMaps.hlsl ----------------------------------------------------------
				half metallic = tex2DNode46.b;
				half3 specular = half3(0.5, 0.5, 0.5);
				half smoothness = staticSwitch17_g329;
				half ao = tex2DNode46.r;
				half alpha = staticSwitch55.r;
		...
		Pass
		{
			     ...
			     ) : SV_Target
			{
			    ...
			    float4 tex2DNode42 = tex2D( _BaseMap, uv_BaseMap );
			    float4 temp_cast_0 = (tex2DNode42.a).xxxx;
		...
		Pass
		{
				...
				) : SV_Target
			{
			   ...
			   #ifdef _DETAILS_ON
			   float4 staticSwitch26_g329 = float4( BlendNormal( temp_output_22_0_g329.rgb , ( ( appendResult56_g329 * 2.0 ) - temp_cast_3 ) ) , 0.0 );
			   #else
			   float4 staticSwitch26_g329 = temp_output_22_0_g329;
			   #endif
			   
			   float4 tex2DNode42 = tex2D( _BaseMap, uv_BaseMap );
			   float4 temp_cast_6 = (tex2DNode42.a).xxxx;
			   float2 uv_Alphamap = i.uv0.xy * _Alphamap_ST.xy + _Alphamap_ST.zw;
			   #ifdef _USEALPHAMAP_ON
			   float4 staticSwitch55 = tex2D( _Alphamap, uv_Alphamap );
			   #else
			   float4 staticSwitch55 = temp_cast_6;
			   #endif
		...
		Pass
		{
			...
			half4 frag(v2f i  ) : SV_Target
			{
				...
				float3 normalizeResult18_g336 = normalize( ( ( ase_tangentWS * mapNormal16_g336.x ) + ( ase_bitangentWS * mapNormal16_g336.y ) + ( ase_normalWS * mapNormal16_g336.z ) ) );
				float3 normalWorld4_g334 = normalizeResult18_g336;
				float2 lightmapUV4_g334 = (i.ase_texcoord6.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				...
				float4 temp_cast_7 = (tex2DNode42.a).xxxx;
				float2 uv_Alphamap = i.uv * _Alphamap_ST.xy + _Alphamap_ST.zw;
				#ifdef _USEALPHAMAP_ON
				float4 staticSwitch55 = tex2D( _Alphamap, uv_Alphamap );
				#else
				float4 staticSwitch55 = temp_cast_7;
				#endif
			...
			// End Injection EMISSION from Injection_Emission_Meta.hlsl ----------------------------------------------------------
				...
				metaInput.Albedo = staticSwitch16_g329.rgb;
				half3 emission = staticSwitch30_g333;
...
/*ASEBEGIN
Version=19903
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;39;-1008,560;Inherit;False;Property;_EmissionColor;Emission Color;18;1;[HDR];Create;False;0;0;0;True;0;False;1,1,1,1;0,0,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;40;-1072,368;Inherit;True;Property;_EmissionMap;Emission Map;17;1;[NoScaleOffset];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;41;-896,-208;Inherit;False;Property;_BaseColor;BaseColor;5;0;Create;False;0;0;0;True;1;MainColor;False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;42;-896,-400;Inherit;True;Property;_BaseMap;Base Map;4;1;[Header];Create;False;1;Base Color;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;43;-944,-16;Inherit;True;Property;_BumpMap;Normal Map;8;3;[Header];[NoScaleOffset];[Normal];Create;False;1;Normal;0;0;True;0;False;-1;None;None;True;0;False;bump;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;44;-816,560;Inherit;False;Constant;_EmptyEmissive;EmptyEmissive;19;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;45;-768,400;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;46;-960,176;Inherit;True;Property;_ORM;ORM;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;linearGrey;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;47;-672,-208;Inherit;True;Property;_Alphamap;Alpha map;7;0;Create;True;1;Base Color;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;48;-624,128;Inherit;False;UnpackNormal;-1;;328;d579cc33c6fa60b4ea9cee9e184b62e3;0;1;1;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;49;-448,-384;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;50;-608,400;Inherit;False;Property;_Emission;Emission Enable;16;0;Create;False;0;0;0;False;4;Space(30);Header(Emissions);Space(10);Toggle;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;51;-640,0;Inherit;False;0;42;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;52;-608,240;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;53;-368,16;Inherit;False;Detail Map;10;;329;7eb669e8a4269ac43a3c284ddafaf020;0;4;21;COLOR;1,1,1,1;False;22;COLOR;0,0,1,0;False;23;FLOAT;0.5;False;218;FLOAT2;0,0;False;3;COLOR;0;COLOR;25;FLOAT;24
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;54;-368,224;Inherit;False;BakeryMonoSH;19;;333;29c9468cd28079b448a58bef1fb32cb5;0;6;8;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;1;False;13;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT;31
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;55;-384,-288;Inherit;False;Property;_usealphamap;use alpha map;6;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;56;17.41797,-145.742;Inherit;False;BRDFMap;1;;337;1affaac2d6e57354aaa8d6573a2b32b8;0;1;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;0,0;Float;False;True;-1;3;UnityEditor.ShaderGraphLitGUI;0;15;LitMAS custom/LitORM/LitORM Transparent;623634af11bd9ab448550ee777f3493e;True;Forward;0;0;Forward;14;False;True;1;1;False;;10;False;;0;5;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;_Cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;1;Lightmode=UniversalForward;True;7;False;0;Hidden/InternalErrorShader;0;0;Standard;24;Workflow;1;0;Surface;1;639228830274869279;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;0;0;Built-in Fog;1;0;Lightmaps;1;0;Volumetrics;1;0;Decals;0;0;Write Depth;0;0;  Early Z (broken);0;0;Vertex Position,InvertActionOnDeselection;1;0;Emission;1;0;PC Reflection Probe;3;0;PC Receive Shadows;1;0;PC Vertex Lights;0;0;PC SSAO;1;0;Q Reflection Probe;0;0;Q Receive Shadows;0;0;Q Vertex Lights;1;0;Q SSAO;0;0;Environment Reflections;1;0;Meta Pass;1;0;0;5;True;True;True;True;True;False;;False;0
...
WireConnection;52;0;46;2
WireConnection;53;21;49;0
WireConnection;53;22;48;0
WireConnection;53;23;52;0
WireConnection;53;218;51;0
WireConnection;54;8;48;0
WireConnection;54;9;49;0
WireConnection;54;10;52;0
WireConnection;54;11;46;3
WireConnection;54;12;46;1
WireConnection;54;13;50;0
WireConnection;55;1;42;4
WireConnection;55;0;47;0
WireConnection;0;0;53;0
WireConnection;0;1;53;25
WireConnection;0;2;54;0
WireConnection;0;3;36;0
WireConnection;0;4;46;3
WireConnection;0;6;53;24
WireConnection;0;7;46;1
WireConnection;0;8;55;0
ASEEND*/
//CHKSM=14B72EBD07CCE23D30F952D994313661E97AD18B