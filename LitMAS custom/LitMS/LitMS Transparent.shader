...
// Force reimport: 2
Shader "LitMAS custom/LitMS/LitMS Transparent"
{
	Properties
	{
		...
		_MetallicSmoothness( "Metallic/Smoothness", 2D ) = "linearGrey" {}
	...
	SubShader
	{
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 uv_MetallicSmoothness = i.uv0XY_bitZ_fog.xy * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode20 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				float smoothness4_g325 = tex2DNode20.a;
				float3 temp_output_9_0_g324 = temp_output_15_0.rgb;
				float3 albedo4_g325 = temp_output_9_0_g324;
				float metalness4_g325 = tex2DNode20.r;
				...
				float3 staticSwitch30_g324 = ( ( temp_output_13_0_g324 + ( _Occlusion * ( diffuseSH4_g325 * temp_output_9_0_g324 ) ) ) + ( specularSH4_g325 * _MonoSHAdjustment ) );
				#else
				...
				float temp_output_23_0_g320 = tex2DNode20.a;
		...
		Pass
		{
			...
			half4 frag(v2f i  ) : SV_Target
			{
				...
				float3 normalizeResult2_g325 = normalize( ase_viewDirWS );
				float3 viewDir4_g325 = normalizeResult2_g325;
				float2 uv_MetallicSmoothness = i.uv * _MetallicSmoothness_ST.xy + _MetallicSmoothness_ST.zw;
				float4 tex2DNode20 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				float smoothness4_g325 = tex2DNode20.a;
				float3 temp_output_9_0_g324 = temp_output_15_0.rgb;
				float3 albedo4_g325 = temp_output_9_0_g324;
...
/*ASEBEGIN
Version=19903
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;26;-1024,544;Inherit;False;Property;_EmissionColor;Emission Color;19;1;[HDR];Create;False;0;0;0;True;0;False;1,1,1,1;0,0,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;27;-1088,352;Inherit;True;Property;_EmissionMap;Emission Map;18;1;[NoScaleOffset];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;38;-672,-16;Inherit;False;0;14;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-976,160;Inherit;True;Property;_MetallicSmoothness;Metallic/Smoothness;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;linearGrey;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;28;-624,384;Inherit;False;Property;_Emission;Emission Enable;17;0;Create;False;0;0;0;False;4;Space(30);Header(Emissions);Space(10);Toggle;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;35;-368,144;Inherit;False;Property;_Occlusion;Occlusion;10;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;37;-384,0;Inherit;False;Detail Map;11;;320;7eb669e8a4269ac43a3c284ddafaf020;0;4;21;COLOR;1,1,1,1;False;22;COLOR;0,0,1,0;False;23;FLOAT;0.5;False;218;FLOAT2;0,0;False;3;COLOR;0;COLOR;25;FLOAT;24
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;5;-384,208;Inherit;False;BakeryMonoSH;20;;324;29c9468cd28079b448a58bef1fb32cb5;0;6;8;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;10;FLOAT;0;False;11;FLOAT;0;False;12;FLOAT;1;False;13;FLOAT3;0,0,0;False;2;FLOAT3;0;FLOAT;31
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;39;0,-144;Inherit;False;BRDFMap;1;;337;1affaac2d6e57354aaa8d6573a2b32b8;0;1;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;0;0,0;Float;False;True;-1;3;UnityEditor.ShaderGraphLitGUI;0;15;LitMAS custom/LitMS/LitMS Transparent;623634af11bd9ab448550ee777f3493e;True;Forward;0;0;Forward;14;False;True;1;1;False;;10;False;;0;5;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;_Cull;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;1;Lightmode=UniversalForward;True;7;False;0;Hidden/InternalErrorShader;0;0;Standard;24;Workflow;1;0;Surface;1;639228830274869279;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;0;0;Built-in Fog;1;0;Lightmaps;1;0;Volumetrics;1;0;Decals;0;0;Write Depth;0;0;  Early Z (broken);0;0;Vertex Position,InvertActionOnDeselection;1;0;Emission;1;0;PC Reflection Probe;3;0;PC Receive Shadows;1;0;PC Vertex Lights;0;0;PC SSAO;1;0;Q Reflection Probe;0;0;Q Receive Shadows;0;0;Q Vertex Lights;1;0;Q SSAO;0;0;Environment Reflections;1;0;Meta Pass;1;0;0;5;True;True;True;True;True;False;;False;0
...
WireConnection;37;23;20;4
WireConnection;37;218;38;0
WireConnection;5;8;7;0
WireConnection;5;9;15;0
WireConnection;5;10;20;4
WireConnection;5;11;20;1
WireConnection;5;12;35;0
...
WireConnection;0;4;20;1
WireConnection;0;6;37;24
WireConnection;0;7;35;0
WireConnection;0;8;17;0
ASEEND*/
//CHKSM=CDB75B4518BEFF5F4CD4F52AD5FBD6F36555A020